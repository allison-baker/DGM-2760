...
function tellStory() {
  nounArray = document.querySelector("#nouns").innerHTML.toLowerCase().split(/\s+/);
  adjArray = document.querySelector("#adjectives").innerHTML.toLowerCase().split(/\s+/);
  verbArray = document.querySelector("#verbs").innerHTML.toLowerCase().split(/\s+/);
